...
public class Pepe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("PEPE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Pepe.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Pepe.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Pepe.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Pepe.ItemViewHolder viewHolder, Jeans model, int position) {
