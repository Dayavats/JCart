...
public class Killer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("KILLER");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Killer.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Killer.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Killer.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Killer.ItemViewHolder viewHolder, Jeans model, int position) {
