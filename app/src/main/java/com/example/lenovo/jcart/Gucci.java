...
public class Gucci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("GUCCI");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Gucci.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Gucci.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Gucci.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Gucci.ItemViewHolder viewHolder, Jeans model, int position) {
