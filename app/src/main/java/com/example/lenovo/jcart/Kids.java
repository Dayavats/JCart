...
public class Kids extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("category").equalTo("Kids");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Kids.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Kids.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Kids.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Kids.ItemViewHolder viewHolder, Jeans model, int position) {
