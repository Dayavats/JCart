...
public class Adidas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("ADIDAS");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Adidas.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Adidas.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Adidas.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Adidas.ItemViewHolder viewHolder, Jeans model, int position) {
