...
public class Louis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("LOUIS PHILLIPE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Louis.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Louis.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Louis.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Louis.ItemViewHolder viewHolder, Jeans model, int position) {
