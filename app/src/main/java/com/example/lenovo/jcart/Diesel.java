...
public class Diesel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("DIESEL");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Diesel.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Diesel.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Diesel.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Diesel.ItemViewHolder viewHolder, Jeans model, int position) {
