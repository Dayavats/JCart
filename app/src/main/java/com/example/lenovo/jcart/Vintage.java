...
public class Vintage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("VINTAGE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Vintage.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Vintage.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Vintage.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Vintage.ItemViewHolder viewHolder, Jeans model, int position) {
