...
public class Duke extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("DUKE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Duke.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Duke.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Duke.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Duke.ItemViewHolder viewHolder, Jeans model, int position) {
