...
public class Zara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("ZARA");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Zara.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Zara.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Zara.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Zara.ItemViewHolder viewHolder, Jeans model, int position) {
