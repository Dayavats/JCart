...
public class Numero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("NUMERO UNO");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Numero.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Numero.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Numero.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Numero.ItemViewHolder viewHolder, Jeans model, int position) {
