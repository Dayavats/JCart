...
public class AllProduct extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,AllProduct.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,AllProduct.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                AllProduct.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(AllProduct.ItemViewHolder viewHolder, Jeans model, int position) {
