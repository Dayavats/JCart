...
public class Jack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("JACK AND JOHN");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Jack.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Jack.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Jack.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Jack.ItemViewHolder viewHolder, Jeans model, int position) {
