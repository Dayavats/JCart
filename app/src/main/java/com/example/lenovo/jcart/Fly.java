...
public class Fly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("FLY MACHINE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Fly.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Fly.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Fly.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Fly.ItemViewHolder viewHolder, Jeans model, int position) {
