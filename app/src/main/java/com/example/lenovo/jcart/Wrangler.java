...
public class Wrangler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("WRANGLER");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Wrangler.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Wrangler.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Wrangler.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Wrangler.ItemViewHolder viewHolder, Jeans model, int position) {
