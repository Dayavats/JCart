...
public class Men extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("category").equalTo("Men");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Men.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Men.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Men.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Men.ItemViewHolder viewHolder, Jeans model, int position) {
