...
public class Reebok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("REEBOK");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Reebok.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Reebok.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Reebok.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Reebok.ItemViewHolder viewHolder, Jeans model, int position) {
