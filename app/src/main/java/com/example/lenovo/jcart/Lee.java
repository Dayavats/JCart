...
public class Lee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("LEE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Lee.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Lee.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Lee.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Lee.ItemViewHolder viewHolder, Jeans model, int position) {
