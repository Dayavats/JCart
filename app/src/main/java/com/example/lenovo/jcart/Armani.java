...
public class Armani extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("ARMANI");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Armani.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Armani.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Armani.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Armani.ItemViewHolder viewHolder, Jeans model, int position) {
