...
public class Hudson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("HUDSON");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Hudson.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Hudson.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Hudson.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Hudson.ItemViewHolder viewHolder, Jeans model, int position) {
