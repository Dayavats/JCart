...
public class Women extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("category").equalTo("women");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Women.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Women.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Women.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Women.ItemViewHolder viewHolder, Jeans model, int position) {
