...
public class Lacoste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lacoste);
        list=(RecyclerView)findViewById(R.id.rv);
        list.setHasFixedSize(true);
        list.setLayoutManager(new LinearLayoutManager(this));
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("LACOSTE");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Lacoste.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Lacoste.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Lacoste.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Lacoste.ItemViewHolder viewHolder, Jeans model, int position) {
