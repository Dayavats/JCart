...
public class Roadster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("ROADSTER");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Roadster.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Roadster.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Roadster.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Roadster.ItemViewHolder viewHolder, Jeans model, int position) {
