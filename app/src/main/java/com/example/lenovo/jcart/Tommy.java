...
public class Tommy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref= FirebaseDatabase.getInstance().getReference().child("Items").orderByChild("brand").equalTo("TOMMY HILFIGHER");
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Jeans,Tommy.ItemViewHolder> FBRA=new FirebaseRecyclerAdapter<Jeans,Tommy.ItemViewHolder>(
                Jeans.class,
                R.layout.view_layout,
                Tommy.ItemViewHolder.class,
                mref
        ) {
            @Override
            protected void populateViewHolder(Tommy.ItemViewHolder viewHolder, Jeans model, int position) {
